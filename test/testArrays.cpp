...
TEST_CASE("Arrays")
{
	...
	{
		std::array<int64_t, 3> array;
		array = module.call<decltype(array)>("getArray");
...
TEST_CASE("Nested arrays")
{
	...
	{
		std::array<std::array<int64_t, 3>, 2> arrayOfArrays;
		arrayOfArrays = module.call<decltype(arrayOfArrays)>("getArrayOfArrays");
	...
	{
		std::array<std::vector<int64_t>, 2> arrayOfArrays;
		arrayOfArrays = module.call<decltype(arrayOfArrays)>("getArrayOfArrays2");
...
TEST_CASE("Array constness")
{
...

	{
		...
		module.call<void>("modifyArray", array);
...
TEST_CASE("Array constness for nested arrays")
{
...

	{
		...
		module.call<void>("modifyNestedArray", arrayOfArrays);
